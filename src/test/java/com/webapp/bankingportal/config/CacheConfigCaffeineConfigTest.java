...
public class CacheConfigCaffeineConfigTest {
    ...
    public void maximumSizeConfigurationImproved() {
        ...
        Caffeine<Object, Object> caffeineConfig = config.caffeineConfig();
        assertEquals(100, caffeineConfig.estimateSize()); // Changed to estimateSize()
        // If you want to test maximumSize method with a specific value, you can do it like this:
        Caffeine<Object, Object> caffeineConfigWithSize = Caffeine.newBuilder().expireAfterWrite(Duration.ofMinutes(15)).maximumSize(50).recordStats().build();
        assertEquals(50, caffeineConfigWithSize.estimateSize()); // Changed to estimateSize()
    }
}