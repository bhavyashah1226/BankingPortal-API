...
public class OtpInfoGetIdTest {
	...
	public void idIsNull() {
		...
		assertNull(otpInfo.getId()); // This test will pass as id is not initialized
	}

	@Test
	public void idIsNotNull() {
		OtpInfo otpInfo = new OtpInfo();
		otpInfo.setId(1L); // Set a valid id
	...
	public void idIsZero() {
		OtpInfo otpInfo = new OtpInfo();
		otpInfo.setId(0L);
		assertEquals(Long.valueOf(0L), otpInfo.getId()); // Proper type casting
	}
	...
	public void idIsNegative() {
		OtpInfo otpInfo = new OtpInfo();
		otpInfo.setId(-1L);
		assertEquals(Long.valueOf(-1L), otpInfo.getId()); // Proper type casting
	}

	@Test
	public void idIsLarge() {
		OtpInfo otpInfo = new OtpInfo();
		otpInfo.setId(Long.MAX_VALUE);
		assertEquals(Long.valueOf(Long.MAX_VALUE), otpInfo.getId()); // Proper type
																		// casting
	}
