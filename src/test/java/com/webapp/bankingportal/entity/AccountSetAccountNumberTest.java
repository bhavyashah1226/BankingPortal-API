...
@Tag("undefined")
@Tag("undefined.setAccountNumber")
public class AccountSetAccountNumberTest {

	@Test
	public void setAccountNumberWithValidInput() {
		// Arrange
	...
	@Test
	public void setAccountNumberWithNullInput() {
		// Arrange
		Account account = new Account();
	...
	@Test
	public void setAccountNumberWithEmptyInput() {
		// Arrange
		Account account = new Account();
		String emptyAccountNumber = "";

		// Act
		account.setAccountNumber(emptyAccountNumber);

		// Assert
		assertEquals(emptyAccountNumber, account.getAccountNumber());
	}

	@Test
	public void setAccountNumberWithWhitespaceInput() {
		// Arrange
		Account account = new Account();
		String accountNumberWithWhitespace = "  1234567890  ";

		// Act
		account.setAccountNumber(accountNumberWithWhitespace);
