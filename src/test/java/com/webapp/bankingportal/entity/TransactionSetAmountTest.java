...
public class TransactionSetAmountTest {
    ...
    public void setTransactionDate() {
        ...
        assertEquals(date, transaction.getTransaction_date());
    }
    ...
    public void setTransactionType() {
        ...
        Transaction transaction = new Transaction();
        TransactionType type = TransactionType.values()[0]; // Assuming there is at least one valid transaction type
    ...
    public void setSourceAccount() {
        ...
        // Initialize other fields of Account object as needed
        transaction.setSourceAccount(account);
        assertEquals(account, transaction.getSourceAccount());
    }
